...
# FILTER SINGLE NULS
data = data[(data.geometry=='DN')|(data.geometry=='CDN')]
...
#data_LH = data_LH[~(data_LH['Ploss']=='')]
data_HL = data_HL[~(data_HL['Ploss']==0)]
#data_HL = data_HL[~(data_HL['Ploss']=='')]
...
ax[0].set_title(r'LH and HL characteristics on X1 height for DN')
...
data_LH = data_LH[~(data_LH['AYE_NE_e']=='')]
data_HL = data_HL[~(data_HL['AYE_NE_e']=='')]
