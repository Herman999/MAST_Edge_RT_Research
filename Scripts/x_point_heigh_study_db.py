...
plt.errorbar(x = data_LH['X1Z'], markersize=15, y = data_LH['Ploss']/(data_LH['NE']**alpha),xerr = data_LH['X1Z_e'], yerr = y_err ,fmt='x', label = 'LH',color = 'green')
...
plt.errorbar(x = data_HL['X1Z'], markersize=15, y = data_HL['Ploss']/(data_HL['NE']**alpha),xerr = data_HL['X1Z_e'], yerr = y_err ,fmt='x', label = 'HL',color = 'red')
