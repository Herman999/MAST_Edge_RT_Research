...
shots = ['Shot(27030, LHt=[(0.1928, 0.193, 0.1927)], HLt=[(0.1963, 0.1963,0.19637)])',
         'Shot(27035, LHt=[(0.1150,0.1017,0.1281)], HLt = [(0.3096,0.3096,0.3098)])',
         'Shot(27036, LHt = [(0.1111, 0.1014,0.1212)], HLt = [(0.3261,0.3261,0.327)])',
         'Shot(27037, LHt=[(0.1089,0.1014,0.1210)], HLt = [(0.3247, 0.3246, 0.3252)])']
...
shots = ['Shot(27444, LHt=[(0.111,0.105,0.116)], HLt=[(0.324,0.323,0.325)])',
         'Shot(27446, LHt=[(0.115,0.110,0.120)], HLt=[(0.3074,0.307,0.308)])',
...
'Shot(24124, LHt=[(0.246,0.242,0.260)], HLt=[(0.2896,0.280,0.2897)])'
]
